...
def check_word(word):
    ...
    word_list = ["සස්ක්‍රයිබ්","සබ්","ලින්ක්","චැනල්","බලන්න","වෙබ්","ගොඩ","සප්","සපෝට්","උදව්වක්","උදවු","සහයෝගය","සහයෝගයක්",
                                    ...
                                    "කොල්ලනේ","වට්ටමක්","ටිකට්","කූපන්","බටනය","මෙන්න","විදිහ","දැනගන්න","එන්න","ආදායම්","ඩෙබිට්","ක්රෙඩිට්",
                                   "බටන්","රෙජිස්ටර්","කැමතිද","සෙට්","එකතුව","බොත්තම","පැත්තටත්","පැත්තට","පැත්තෙ","ආරාධනා","ප්‍රමෝට්","බැලුවොත්",
                                   "උපයන්න","විකිණීමට","ඔබන්න","ක්ලික්","නොමිලේ","විස්තරය"
                                  ,'ගන්න','සල්ලි','ඔයාට','අය','කරලා','වෙන්න','පුලුවන්','පුලුවන්','නම්','link','website','site',
