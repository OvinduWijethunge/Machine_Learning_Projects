...
def check_word(word):
    ...
    word_list = ["සස්ක්‍රයිබ්","සබ්","ලින්ක්","චැනල්","බලන්න","වෙබ්","ගොඩ","සප්","සපෝට්","උදව්වක්","උදවු","සහයෝගය","සහයෝගයක්","නාලිකාවෙන්","SUBSCRIBE","Subscribe","subscribe",
                   ...
                   ,'එක','එකක්','කරන්න','ගන්න','සල්ලි','ඔයාට','එකට','අය','කරලා','වෙන්න','පුලුවන්','පුලුවන්','නම්','link','website','site','එකතු','register','සයිට්','වෙබ්','මුදල්','රෙජිස්ටර්','චැනල්','නොමිලේ','පහල','ලියාපදිංචි','click','join','කරගන්න','Register','ආදායමක්','ලාභයක්','free','යාලුවනේ','මුදලක්','ලාභය','කට්ටිය','පහත','Profit','ලැබෙනව','පහලින්','share','ඉක්මනින්','ජය','සප්','යටින්','පුංචි','අලෙවි','ගෙවනවා','ඔයාගෙම','ආදායම්','වෙබ්සයිට්','ලාභයම','ආදායම','උපයන්න','invite','කලොත්','යට','අමතර','සේවා','පැත්තෙ','sale','Credit','ආයෝජනය','බට්න්','හම්බෙනවා','download','විකුණන','නොමිලේම','ගිනුමට','Click','ඔබන්න','එකතුවෙන්න','සහයෝගය','විනාඩියක්','කියවන්න','හම්බෙනවා','ශෙයා','ජයවේවා','credit','උදවු','වාසිය','වාසියක්','ලාභයෙන්'  ]             
