...
def convert_audio_to_text(filepath, chunksize=30000):
    ...
    try:
        ...
        for index,chunk in enumerate(chunks):
            #TODO io.BytesIO()
            chunk.export('E:/youtube-sinhala-spam-comments-filter-deployement/sample.wav', format='wav')
            with sr.AudioFile('E:/youtube-sinhala-spam-comments-filter-deployement/sample.wav') as source:
...
# =============================================================================
# for x in ['hUchk8OSYfo','SQUThhNL6E8']:
#     
#     download_comments_and_content(x)
#     print('---------------------------------------------------------')
# 
# =============================================================================
